function sorted_columns = CONFLICT_get_conflict_col_names(data, conflict_level)
...
selected_columns = column_names(startsWith(column_names, ['con_c' num2str(conflict_level)]));
